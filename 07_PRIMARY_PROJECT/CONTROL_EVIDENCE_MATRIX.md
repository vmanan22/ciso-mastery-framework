...
| **SC-06** | Static Application Security Testing (SAST) with Quality Gate | [`.semgrep.yml`](.semgrep.yml) + Bandit | SAST Stage 2 Quality Gate Script | [PR #15 CI Run #32972289149](https://github.com/vmanan22/ciso-mastery-framework/actions/runs/32972289149) (`bandit-results.json`, `semgrep.sarif`) | **verified** | 2026-08-26 |
...
* **In Progress**: 1 (8%)
* **Planned**: 4 (31%)
* **Reference CI Run**: [PR #15 Run #32972289149](https://github.com/vmanan22/ciso-mastery-framework/actions/runs/32972289149) (Passed Stages 0–4, Visibly Skipped Stages 5–6)
